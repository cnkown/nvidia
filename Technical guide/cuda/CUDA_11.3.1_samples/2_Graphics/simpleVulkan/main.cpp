...
public:
    ...
    void initVulkanApp() {
        ...
        // Create the timeline semaphore to sync cuda and vulkan access to vertex buffer
        createExternalSemaphore(m_vkTimelineSemaphore, getDefaultSemaphoreHandleType());
        // Import the timeline semaphore cuda will use to sync cuda and vulkan access to vertex buffer
